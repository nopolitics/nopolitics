...
// You should implement (or define an empty function body) those functions which are called by Nopolitics plugin manager
...
// This API return always true now, since Nopolitics isn't compiled in ANSI mode anymore
