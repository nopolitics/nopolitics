...
-x : Move Nopolitics to indicated left side position on the screen\r\
-y : Move Nopolitics to indicated top position on the screen\r\
-monitor: Open file with file monitoring enabled\r\
-nosession : Launch Nopolitics without previous session\r\
-notabbar : Launch Nopolitics without tabbar\r\
-ro : Make the filePath read only\r\
-systemtray : Launch Nopolitics directly in system tray\r\
-loadingTime : Display Nopolitics loading time\r\
-alwaysOnTop : Make Nopolitics always on top\r\
...
-quickPrint : Print the file given as argument then quit Nopolitics\r\
...
-titleAdd=\"string\": add string to Nopolitics title bar\r\
...
public:
	...
	static HWND gNppHWND;	//static handle to Nopolitics window, NULL if non-existant
