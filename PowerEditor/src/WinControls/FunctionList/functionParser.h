...
private:
	...
	generic_string _xmlDirPath; // The 1st place to load function list files. Usually it's "%APPDATA%\Nopolitics\functionList\"
	generic_string _xmlDirInstalledPath; // Where Nopolitics is installed. The 2nd place to load function list files. Usually it's "%PROGRAMFILES%\Nopolitics\functionList\" 
